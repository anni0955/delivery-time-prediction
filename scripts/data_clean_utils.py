...
def drop_columns(data:pd.DataFrame, cols: list):
    data = data.drop(columns=cols)
    return data


def perform_data_cleanining(data: pd.DataFrame, saved_data_path='cleaned-data.csv'):
    cleaned_data = (
        data
        ...
        .pipe(drop_columns, cols=cols_to_drop)
    )
